...
const MODULES = [
    ...
    { num:"04", title:"Практика под нагрузкой",               desc:"Курс включает преимущественно практические занятия по поиску и анализу ценных бумаг. Работа с реальными кейсами в режиме реального времени.",              topics:["Разбор кейсов","Реальные сделки","Система решений"] },
];
