...
const PILLARS = [
    {
        ...
        desc: "Только финансовая отчётность. P/E, EV/EBITDA, свободный денежный поток — не графики.",
    },
    {
        icon: (
            <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
        ...
        desc: "Ищем компании, которые рынок временно игнорирует. Покупаем дёшево — ждём справедливой цены.",
    },
    {
        icon: (
            <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
        ...
        desc: "Строим позиции на годы, а не на дни. Сложный процент и терпение — главные инструменты.",
    },
];
                ...
                <div className="phil-grid" style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"clamp(32px,6vw,80px)", alignItems:"start", marginTop:16 }}>
                    ...
                    <div style={{ opacity:vis?1:0, transform:vis?"none":"translateX(24px)", transition:"opacity .7s cubic-bezier(.22,1,.36,1) .12s, transform .7s cubic-bezier(.22,1,.36,1) .12s" }}>
                        ...
                        <p style={{ fontSize:"clamp(13px,1.8vw,16px)", color:"#9a9b8e", lineHeight:1.8, fontWeight:300, margin:0 }}>
                            Мы отрицаем угадывание движений цены. Наш метод — глубокий анализ финансовой отчётности компаний. Мы находим недооценённые активы и строим капитал на реальных цифрах, а не на случайных свечах на графике.
                        </p>
                    </div>
                </div>
            </div>
